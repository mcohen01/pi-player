...
//////////////// Editable options ////////////////
	...
	$tutorialTitle = 'ENJOY LIFE Tutorials for Miami University Students of Dr. Darrel Davis - ';
...
<p>
	Your coursework addresses behavioral views of learning. That content is just a small part of a much larger perspective that extends into many aspects of life for everyone. The tutorials below will expand on the behavioral perspective and may provide some extra benefits in your life. Indeed, the tutorials may turn your perspective about happiness and satisfaction inside out.  Start with the first selection.  After you complete a tutorial, go to the next one in the list.  Take breaks between tutorials rather than trying to complete several in one sitting. You will be most successful with these tutorials if you minimize distractions around you (Tip: Turn off your phone and message alerts).  Read slowly and carefully as you take the road to enjoying life more.
</p>
...
EOT;
	...
	// **** MUST START WITH ./ AND MUST END WITH /
	$outfileDirectory = './preparingforthefuture/enjoylifemiamiu-out/';
...
?>
      ...
      <script src="https://cdnjs.cloudflare.com/ajax/libs/json2/20140204/json2.min.js"></script>
		...
		<script>
			function check() {
				if (document.getElementById('Student').value === '') {
					alert('Please carefully fill in your UniqueID which is the first part of your Miami email address');
					return false;
				}
		...
		<strong>Step 1 - Carefully type your UniqueID which is the first part of your Miami email address:</strong><br>
		...
		<p>  <strong>Step 3 - Click Begin <?php echo ($isTest ? 'test' : 'tutorial'); ?>: </strong><br>
		  <input style="margin-top: 10px;" class="btn btn-primary" type="submit" value="Begin <?php echo ($isTest ? 'Test' : 'Tutorial'); ?>"/>
		<hr>
		<p>
